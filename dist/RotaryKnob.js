...
function RotaryKnob({ width = 160, height = 160, value = 80, max = 127, backgroundColor = '#ccc', color = '#37332ee0', }) {
  ...
  return (_jsxs('div', {
    children: [_jsx('canvas', { width: width, height: height, onPointerDown: handleDown, onPointerMove: handleMove, onPointerUp: handleCancel, ref: canvasRef }, void 0), _jsx('div', { children: val.toString().slice(0, 5) }, void 0)]
  }, void 0))
  function yToVal(y) {
